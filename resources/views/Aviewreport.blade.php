                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                        <a class="dropdown-item" href="/Acategory">Add Category</a>
                                        <a class="dropdown-item" href="/Aviewcat">View Category</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                        <a class="dropdown-item" href="/Abrand">Add Brand</a>
                                        <a class="dropdown-item" href="/Aviewbrand">View Brand</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                        <a class="dropdown-item" href="/Aproduct">Add Product</a>
                                        <a class="dropdown-item" href="/Aview">View product</a>
...
<div class="row">
    ...
    <div class="col-lg-12">
        <br> <br><table class="table "id="example">
            <tr>
                <th>ORDER-ID</th>
                <th>CUSTOMER-NAME</th>
                <th>PRODUCT-NAME</th>
    ...
    <button style=" " class="btn_1 btn-lg" id="json">Download</button>
</div>
